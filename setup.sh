...
echo ""
echo "  This command starts the compatibility source runtime only."
echo "  Its bundled detector is not an accepted GonKenLab Agent interface."
echo "  The release path will use push-to-talk; wake word is gated separately."
echo ""
