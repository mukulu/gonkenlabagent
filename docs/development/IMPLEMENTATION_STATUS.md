...
| M10.11 — Hybrid HIL and simulation-aware voice | pending | not-run | docs/development/V09_SIMULATION_HIL_EXTENSION_PLAN.md Implement hybrid sensor/actuator combinations, voice provenance wording and simulation-aware physical acceptance blocking. Physical actuation remains target-gated. |
