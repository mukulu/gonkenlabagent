...
<!-- MILESTONES -->
Checkpoint scope: **Historical M-series ledger retained for compatibility. Current implementation authority is CURRENT_GATES.json / docs/CURRENT_STATE.md. B15 repairs B14 voice capture, streaming wake/whole-utterance handling, concise fan speech and latency evidence; see b15/REPAIR_RECORD.md. The current physical B15 wake/audio/reboot acceptance remains open.**
...
| M4.2 — Audio discovery and recovery | host-verified | not-run | b15/REPAIR_RECORD.md; b15/verification/VERIFICATION.json; tests/unit/test_b15_capture_repair.py; tests/unit/test_b15_streaming_wake.py; tests/integration/test_b15_pcm_stream_process.py B15 code paths are host-tested; native synthetic misses remain documented. Actual Raspberry Pi capture, keyword recall/false wakes, Whisper/Piper latency, microphone hotplug and no-login reboot require exact-package target evidence. |
...
| M10.24 — Final Raspberry Pi environment and release acceptance | host-verified | not-run | docs/development/V09_COMPREHENSIVE_CLOSURE_BLUEPRINT_CHECKPOINT_25.md; docs/RASPBERRY_PI_ACCEPTANCE_RUN.md; checkpoint-29/30 target transcripts: GPIO23 gpiochip0:23 manual 0/OFF, 1/ON, 0/OFF physical fan response; checkpoint-30 activation migrated to 34aee184d348f35db46fecacd36a369d9974c5a4, then a stale historical release 3b25b81c5bc7d4e24268726ad7f7b71296215a03 incorrectly failed post-activation pruning; checkpoint-30 local rerun authorized gonkenlab, passed identity preflight, requested I2C enablement, and paused before INSTALLATION_COMPLETE; support evidence then showed the active checkpoint-30 binding bridge and /dev/i2c-1 ready; checkpoint-31 target transcript/failure bundle: commit 8c9bd8b6a657f1a793c038bec8319d1f868315c7 built successfully then deterministically failed activation with RELEASE_INVALID payload digest differs before INSTALLATION_COMPLETE; support bundle retained checkpoint-30 current binding/I2C readiness; checkpoint-32 target transcript: commit 636285827c8947ba689400c9b1dc217ea5521130 activated and advanced through target runtime/I2C/model/speech/application-service gates before preferred Bluetooth AIRHUG connection failed; same-commit curl/local reruns then failed immutable_release with RELEASE_ACTIVE_INVALID; checkpoint-32 support bundle showed deterministic AIRHUG USB capture+playback, I2C ready, active gpiod bridge ready, and repeated WAKE_LED_GPIO_LINE_AMBIGUOUS events; checkpoint-33 target transcript: commit e5d05d105228d4cb8cf81201435d122a89435e6f built and activated, passed target identity/I2C/runtime bindings, environment service, Ollama, Whisper, Piper, speech smoke, application service, Bluetooth/autoconnect and runtime context, then failed appliance readiness because gonken-agent.service repeatedly emitted WAKE_LED_GPIO_LINE_AMBIGUOUS for GPIO22 Partial target evidence remains preserved: GPIO23/relay/PENGLIN/ELUTENG manual physical actuation PASS; SHT31 is visible at 0x44 on /dev/i2c-1; checkpoint 33 reached the live application service and final appliance-readiness gate but did not reach INSTALLATION_COMPLETE because GPIO22 remained ambiguous on the real Pi 5. Retest exact checkpoint 34, require its early non-actuating GPIO17/22/23/27 identity gate plus INSTALLATION_COMPLETE, then complete GonKen CLI actuator, real SHT31 diagnostics, full-real controller, voice/wake, faults, reboot/no-login, update/rollback/reinstall and final support evidence. |
| M10.25 — Target activation contract migration and upgrade compatibility repair | host-verified | not-run | scripts/release_manager.py; tests/fixtures/release_fakes.py; tests/unit/test_m3_3_release_manager.py; tests/integration/test_release_lifecycle_process.py; docs/development/evidence/v09/checkpoint30/affected_unit.log; docs/development/evidence/v09/checkpoint30/affected_integration.log; docs/development/evidence/v09/checkpoint30/final_unit_accounting.json; docs/development/evidence/v09/checkpoint30/final_integration_accounting.json; docs/development/evidence/v09/checkpoint30/final_release_lifecycle_accounting.json; docs/development/V09_CHECKPOINT_30_REPORT.md Install exact checkpoint 30 on the Raspberry Pi. The old post-verified pre-bridge active release may be used only as a bounded state-bound transition source; the new candidate remains under the strict bridge manifest/API contract. Target acceptance is not claimed until INSTALLATION_COMPLETE and the remaining M10.24 campaign pass. |
| M10.26 — Target install convergence, planned reboot and voice prerequisite hardening | host-verified | not-run | scripts/release_manager.py; scripts/i2c_manager.py; scripts/lib/install_engine.sh; scripts/install.sh; scripts/bluetooth_manager.py; scripts/appliance_manager.py; scripts/install_summary.py; src/gonken_agent/voice_runtime.py; tests/unit/test_v09_install_dependency_graph.py; docs/development/evidence/v09/checkpoint31/target_incident_summary.json; docs/development/evidence/v09/checkpoint31/final_unit_accounting.json; docs/development/evidence/v09/checkpoint31/final_integration_accounting.json; docs/development/evidence/v09/checkpoint31/final_release_lifecycle_accounting.json; docs/development/V09_CHECKPOINT_31_REPORT.md; docs/development/V09_CHANGE_VERIFICATION_REPORT_CHECKPOINT_31.md Checkpoint-31 target retest was superseded by the checkpoint-32 M10.27 repair after the Pi exposed post-seal current-candidate self-mutation. Preserve M10.26 host evidence, but use checkpoint 32 for the next target campaign. Physical audio, INSTALLATION_COMPLETE and the rest of M10.24 remain target evidence. |
| M10.27 — Current-release immutable seal and post-seal runtime isolation repair | host-verified | not-run | scripts/release_manager.py; scripts/install.sh; scripts/ci.sh; tests/unit/test_m3_3_release_manager.py; tests/unit/test_v09_install_dependency_graph.py; tests/integration/test_release_lifecycle_process.py; tests/integration/test_speech_lifecycle_process.py; docs/development/evidence/v09/checkpoint32/target_incident_summary.json; docs/development/evidence/v09/checkpoint32/final_unit_accounting.json; docs/development/evidence/v09/checkpoint32/final_integration_accounting.json; docs/development/evidence/v09/checkpoint32/final_release_lifecycle_accounting.json; docs/development/V09_CHECKPOINT_32_REPORT.md Checkpoint-32 target retest exposed a later same-current-release rerun defect and optional-audio convergence gap after successful activation. Preserve M10.27 host evidence, but use checkpoint 33 M10.28 for the next target campaign. INSTALLATION_COMPLETE and remaining M10.24 physical evidence remain open. |
| M10.28 — Same-commit runtime stability, optional audio fallback and Pi5 GPIO convergence | host-verified | not-run | scripts/release_manager.py; scripts/install.sh; scripts/bluetooth_manager.py; scripts/service_manager.py; scripts/environment_service_manager.py; packaging/systemd/gonken-agent.service; packaging/systemd/gonken-environment.service; packaging/systemd/gonken-bluetooth-autoconnect.service; src/gonken_agent/interaction/gpiod_ptt.py; src/gonken_agent/environment/actuators/gpiod_relay.py; tests/unit/test_m3_3_release_manager.py; tests/unit/test_x4_bluetooth_manager.py; tests/unit/test_v09_install_dependency_graph.py; tests/unit/test_m5_1_ptt_runtime.py; tests/unit/test_v09_environment_hardware_adapters.py; docs/development/evidence/v09/checkpoint33/target_incident_summary.json; docs/development/evidence/v09/checkpoint33/final_unit_accounting.json; docs/development/evidence/v09/checkpoint33/final_integration_accounting.json; docs/development/evidence/v09/checkpoint33/final_release_lifecycle_accounting.json; docs/development/V09_CHECKPOINT_33_REPORT.md Checkpoint-33 target retest advanced through release activation and all installer/runtime/audio prerequisites to the final appliance-readiness gate, where the real Pi still reported WAKE_LED_GPIO_LINE_AMBIGUOUS for GPIO22. Preserve M10.28 host evidence, but use checkpoint 34 M10.29 for the next target campaign. INSTALLATION_COMPLETE and remaining M10.24 physical evidence remain open. |
| M10.29 — Authoritative runtime boundary, transport-neutral audio and early Pi5 GPIO identity convergence | host-verified | not-run | docs/development/V09_CHECKPOINT_34_FINAL_CONVERGENCE_BLUEPRINT.md; src/gonken_agent/gpio_resolver.py; scripts/gpio_identity_preflight.py; scripts/release_manager.py; scripts/install.sh; scripts/bluetooth_manager.py; src/gonken_agent/interaction/gpiod_ptt.py; src/gonken_agent/environment/actuators/gpiod_relay.py; tests/unit/test_m3_3_release_manager.py; tests/unit/test_m5_1_ptt_runtime.py; tests/unit/test_v09_environment_hardware_adapters.py; tests/unit/test_v09_gpio_identity_preflight.py; tests/unit/test_v09_install_dependency_graph.py; tests/unit/test_x4_bluetooth_manager.py; tests/integration/test_release_lifecycle_process.py; docs/development/evidence/v09/checkpoint34/target_incident_summary.json; docs/development/evidence/v09/checkpoint34/final_unit_accounting.json; docs/development/evidence/v09/checkpoint34/final_integration_accounting.json; docs/development/evidence/v09/checkpoint34/final_speech_lifecycle_accounting.json; docs/development/evidence/v09/checkpoint34/final_release_lifecycle_accounting.json; docs/development/V09_CHECKPOINT_34_REPORT.md; docs/development/V09_CHANGE_VERIFICATION_REPORT_CHECKPOINT_34.md Install exact checkpoint 34 on the Raspberry Pi. The installer must prove GPIO17/22/23/27 coherently through the shared non-actuating header resolver before environment/application readiness, must continue through deterministic USB/wired duplex audio if preferred Bluetooth is unavailable, and repeated local-checkpoint/curl runs of the same commit must remain convergent without current-release dead ends. Target INSTALLATION_COMPLETE and the rest of M10.24 remain unclaimed until observed. |
| M10.30 — Post-checkpoint-34 reliability-first control plane and canonical GPIO alias identity | host-verified | not-run | docs/development/V09_POST_CKPT34_RELIABILITY_FIRST_BLUEPRINT.md; docs/development/V09_CHECKPOINT_35_RELIABILITY_FIRST_REPORT.md; docs/development/MASTER_BLUEPRINT.md; docs/development/DECISIONS.md; docs/development/TEST_MATRIX.md; src/gonken_agent/gpio_resolver.py; scripts/gpio_identity_preflight.py; tests/unit/test_v09_gpio_identity_preflight.py; tests/unit/test_m5_1_ptt_runtime.py; tests/unit/test_v09_environment_hardware_adapters.py No Raspberry Pi candidate is produced from this checkpoint. Complete the reliability-first host/target-shadow gate, exact archive verification and then the real M10.24/WP-L Raspberry Pi campaign before using RELEASE_CANDIDATE or STABLE_FINAL_RELEASE status. |
| M10.31 — Sanitized target manifest and target-shadow GPIO replay | host-verified | not-run | scripts/target_probe.py; tests/unit/test_v09_target_probe.py; tests/fixtures/target_probe/checkpoint34_duplicate_rp1_alias_manifest.json; tests/fixtures/target_probe/distinct_duplicate_header_manifest.json; scripts/release_manager.py; tests/unit/test_m3_3_release_manager.py; docs/development/V09_CHECKPOINT_36_TARGET_SHADOW_REPORT.md; docs/development/MASTER_BLUEPRINT.md; docs/development/DECISIONS.md; docs/development/TEST_MATRIX.md A real Raspberry Pi must still run the live target probe, the sanitized manifest must be reviewed and committed as target-shadow evidence, and release-readiness/CI gating must require replay before any future Pi candidate package. |
| M10.32 — Release-readiness target-shadow gate | host-verified | not-run | scripts/release_readiness.py; tests/unit/test_release_readiness.py; scripts/target_probe.py; tests/fixtures/target_probe/checkpoint34_duplicate_rp1_alias_manifest.json; tests/fixtures/target_probe/distinct_duplicate_header_manifest.json; docs/development/V09_CHECKPOINT_37_TARGET_SHADOW_READINESS_REPORT.md; docs/development/MASTER_BLUEPRINT.md; docs/development/DECISIONS.md; docs/development/TEST_MATRIX.md This checkpoint reaches only READY_FOR_HOST_TARGET_SHADOW_GATE. Add sanitized real-target manifests, expand target-shadow replay for audio fallback, service identity and dirty installer/release states, complete exact archive qualification, and then prepare a future Raspberry Pi RELEASE_CANDIDATE only after the host/target-shadow release-candidate gate is completely satisfied. |
| M10.33 — Target-shadow capability and state replay expansion | host-verified | not-run | scripts/target_probe.py; scripts/release_readiness.py; tests/unit/test_v09_target_probe.py; tests/unit/test_release_readiness.py; tests/fixtures/target_probe/capability_ready_audio_identity_release_manifest.json; tests/fixtures/target_probe/ambiguous_audio_route_manifest.json; tests/fixtures/target_probe/missing_service_identity_manifest.json; tests/fixtures/target_probe/dirty_release_state_manifest.json; docs/development/V09_CHECKPOINT_38_TARGET_SHADOW_CAPABILITY_REPORT.md; docs/development/MASTER_BLUEPRINT.md; docs/development/DECISIONS.md; docs/development/TEST_MATRIX.md This checkpoint expands host/target-shadow replay only. A real Raspberry Pi must still capture sanitized target manifests for the exact hardware/service/release state, exact archive qualification remains open, and no Raspberry Pi RELEASE_CANDIDATE may be prepared until the complete host/target-shadow release-candidate gate is satisfied. |
| M10.34 — Exact archive qualification gate | host-verified | not-run | scripts/archive_qualifier.py; tests/unit/test_v09_archive_qualifier.py; scripts/release_manager.py; tests/unit/test_m3_3_release_manager.py; docs/development/V09_CHECKPOINT_39_EXACT_ARCHIVE_QUALIFICATION_REPORT.md; docs/development/MASTER_BLUEPRINT.md; docs/development/DECISIONS.md; docs/development/TEST_MATRIX.md This checkpoint qualifies exact archives as host/package evidence only. A real Raspberry Pi candidate remains blocked until sanitized real-target manifests, complete host/target-shadow release-candidate gating and M10.24 target execution are completed without deriving physical claims from archive checks. |
| M10.35 — I2C/SHT31 and environment profile target-shadow replay | host-verified | not-run | scripts/target_probe.py; scripts/release_readiness.py; tests/unit/test_v09_target_probe.py; tests/unit/test_release_readiness.py; tests/fixtures/target_probe/i2c_sht31_ready_full_real_manifest.json; tests/fixtures/target_probe/i2c_reboot_required_manifest.json; tests/fixtures/target_probe/sht31_absent_real_sensor_manifest.json; tests/fixtures/target_probe/environment_full_real_missing_relay_manifest.json; tests/fixtures/target_probe/environment_disabled_safe_manifest.json; docs/development/V09_CHECKPOINT_40_I2C_ENVIRONMENT_REPLAY_REPORT.md; docs/development/MASTER_BLUEPRINT.md; docs/development/DECISIONS.md; docs/development/TEST_MATRIX.md This checkpoint expands host/target-shadow replay only. Live target manifest capture remains non-actuating, and a real Raspberry Pi candidate remains blocked until sanitized real-target manifests, complete host/target-shadow release-candidate gating and M10.24 target execution are completed without deriving physical claims from replay checks. |
| M10.36 — Lifecycle, runtime, resource and model-finalization target-shadow replay | host-verified | not-run | scripts/target_probe.py; scripts/release_readiness.py; tests/unit/test_v09_target_probe.py; tests/unit/test_release_readiness.py; tests/fixtures/target_probe/release_lifecycle_ready_manifest.json; tests/fixtures/target_probe/partial_installer_state_manifest.json; tests/fixtures/target_probe/stale_release_temp_manifest.json; tests/fixtures/target_probe/corrupt_historical_noncurrent_manifest.json; tests/fixtures/target_probe/runtime_authoritative_drift_manifest.json; tests/fixtures/target_probe/support_wrong_release_manifest.json; tests/fixtures/target_probe/old_systemd_units_manifest.json; tests/fixtures/target_probe/service_restart_failure_manifest.json; tests/fixtures/target_probe/operator_missing_control_group_manifest.json; tests/fixtures/target_probe/low_disk_manifest.json; tests/fixtures/target_probe/interrupted_model_finalization_manifest.json; docs/development/V09_CHECKPOINT_41_LIFECYCLE_RUNTIME_REPLAY_REPORT.md; docs/development/MASTER_BLUEPRINT.md; docs/development/DECISIONS.md; docs/development/TEST_MATRIX.md This checkpoint expands host/target-shadow replay only and deliberately blocks only current-release, service/runtime, operator, resource and model states that can invalidate delivery or target convergence. Live Raspberry Pi manifests, exact candidate execution and M10.24 physical evidence remain target-run work. |
| M10.37 — Single-ZIP target evidence and failure-bundle completeness | host-verified | not-run | src/gonken_agent/support.py; src/gonken_agent/operations.py; scripts/collect-support.sh; scripts/installer_failure_bundle.py; tests/unit/test_support_export.py; tests/unit/test_v09_installer_failure_bundle.py; tests/integration/test_support_collection_process.py; docs/development/V09_CHECKPOINT_42_SINGLE_ZIP_TARGET_EVIDENCE_REPORT.md; docs/development/MASTER_BLUEPRINT.md; docs/development/DECISIONS.md; docs/development/TEST_MATRIX.md Future target troubleshooting should upload the single support or installer-failure ZIP produced by the package. That ZIP now carries hardware/runtime topology and bounded diagnostic evidence for host-side repair. Physical fan motion, acoustic quality, SHT31 placement and manual observations still must be recorded by the target operator and cannot be inferred merely from ZIP structure. |
| M10.38 — Post-checkpoint-42 semantic convergence and canonical evidence architecture | host-verified | not-run | src/gonken_agent/evidence.py; src/gonken_agent/support.py; src/gonken_agent/voice_runtime.py; scripts/appliance_manager.py; scripts/installer_failure_bundle.py; scripts/target_probe.py; scripts/release_readiness.py; tests/fixtures/target_probe/ckpt42_20260917_audio_capture_runtime_failure_manifest.json; tests/unit/test_v09_responsibility_boundaries.py; docs/development/V09_CHECKPOINT_43_FAILURE_CHRONOLOGY.md; docs/development/V09_CHECKPOINT_43_RESPONSIBILITY_LEDGER.md; docs/development/V09_CHECKPOINT_43_CONVERGENCE_REPORT.md; docs/development/evidence/v09/ckpt43_final_release_readiness_clean.log; docs/development/evidence/v09/ckpt43_final_t0.log; docs/development/evidence/v09/ckpt43_rc1_archive_qualification.json; docs/development/evidence/v09/ckpt43_final_code_verification.md Run the exact qualified checkpoint-43 package on the real Raspberry Pi. Only that target campaign may close M10.24 physical service-user microphone/speaker behavior, wake/acoustic interaction, SHT31 placement/measurements, relay/PENGLIN/fan motion, reboot/no-login persistence and update/rollback/reinstall. If installation fails, upload the single combined evidence ZIP emitted by the installer. |
| M10.39 — V04 component readiness, release identity and environment commissioning foundation | host-verified | not-run | src/gonken_agent/release_identity.py; src/gonken_agent/readiness.py; src/gonken_agent/environment/policy.py; src/gonken_agent/environment/daemon.py; scripts/environment_profile_manager.py; scripts/environment_service_manager.py; scripts/environment_readiness.py; bootstrap.sh; scripts/lib/install_engine.sh; scripts/install.sh; scripts/target_probe.py; scripts/release_readiness.py; tests/fixtures/target_probe/ckpt43_20260917_readiness_identity_mismatch_manifest.json; docs/development/V09_CHECKPOINT_44_V4_FOUNDATION_REPORT.md; docs/development/evidence/v09/ckpt44_focused_component_environment.log; docs/development/evidence/v09/ckpt44_environment_install_integration.log; docs/development/evidence/v09/checkpoint45/checkpoint44_target_hybrid_observation.json Checkpoint 44 host foundation is now supplemented by a fresh predecessor-package Raspberry Pi observation: the installation reached READY with real SHT31 on bus 1/address 0x44 through gonken-environment and a simulated actuator. That observation does not establish Checkpoint-45 exact-package acceptance, real GPIO23/ELUTENG actuation, multi-model Pi performance, reboot/no-login persistence, or physical tool HIL; those remain later target gates. |
| M10.40 — V04 multi-model, typed-tool and causal-evidence convergence | host-verified | not-run | src/gonken_agent/llm/models.py; src/gonken_agent/llm/admin.py; src/gonken_agent/llm/ollama.py; src/gonken_agent/tool_broker.py; src/gonken_agent/component_status.py; src/gonken_agent/voice_runtime.py; src/gonken_agent/support.py; scripts/model_roster_manager.py; packaging/ollama-model-roster.toml; tests/unit/test_v09_multimodel_tools.py; tests/unit/test_v09_llm_admin_components.py; tests/unit/test_v09_model_roster_manager.py; tests/unit/test_support_export.py; docs/development/V09_CHECKPOINT_45_MULTIMODEL_TOOL_CONVERGENCE_REPORT.md; docs/development/evidence/v09/checkpoint45/checkpoint44_target_hybrid_observation.json; docs/development/evidence/v09/checkpoint45/checkpoint45_host_verification_summary.json; docs/development/evidence/v09/checkpoint45/full_unit_phase.log; docs/development/evidence/v09/checkpoint45/speech_lifecycle_process.log; docs/development/V09_CHECKPOINT_45_CODE_CHANGE_VERIFICATION.md Host/package implementation is verified through the checkpoint-close regression portfolio. Run the exact checkpoint-45 package on Raspberry Pi 5 to provision/validate all three admitted models, execute per-model semantic tool and latency/resource benchmarks, exercise local time/date and real-SHT31/simulated-fan voice tools, verify reboot/no-login/model-selection persistence, and only then proceed to separately supervised WP-45C real GPIO23/ELUTENG fan actuation. |
<!-- /MILESTONES -->
...
- Portable checkpoint archives contain full Git history and are packaged with `origin=https://github.com/mukulu/gonkenlabagent.git`. They never embed credentials or push automatically; the maintainer explicitly merges the development branch into `main` and pushes when ready.
...
## V09 Checkpoint 40 — I2C/SHT31 and environment profile target-shadow replay — 2026-09-17

Checkpoint 40 advances M10.35 as host/target-shadow evidence only. `target_probe.py --replay` now supports opt-in `i2c_sht31` and `environment_profile` requirements. The replay gate distinguishes ready SHT31 diagnostic summaries from planned `I2C_REBOOT_REQUIRED` pauses and absent sensors, and binds the four governed static environment profiles to the evidence they imply. Simulation profiles remain safe without physical hardware evidence; real-sensor profiles require SHT31 readiness; relay-backed profiles require GPIO23 identity; `full-real` requires simulation runtime control disabled.

Evidence is represented by 11 required target-shadow fixtures in `release_readiness.py`, including ready full-real, planned reboot, absent SHT31, missing relay and full-simulation-safe profile cases. These checks do not probe live I2C, actuate GPIO, read audio or claim physical acceptance.

Remaining: sanitized real Raspberry Pi manifests must still be captured and reviewed; the complete host/target-shadow release-candidate gate must still be satisfied from exact archives; M10.24 remains target not-run for `INSTALLATION_COMPLETE`, physical SHT31, relay/fan, audio, wake/voice, reboot/no-login, update, rollback and reinstall evidence.

## V09 Checkpoint 41 — lifecycle/runtime/resource target-shadow replay — 2026-09-17

Checkpoint 41 advances M10.36 as host/target-shadow evidence only. It expands replay beyond hardware profile checks into the delivery states that most directly affect whether a package can be used successfully: current-release identity, install completion, stale temporary artifacts, runtime mutation, support bundle release binding, managed systemd unit currency, restart health, operator control-group membership, disk headroom and Ollama model finalization.

The checkpoint deliberately avoids over-blocking: a corrupt or digest-mismatched historical release is tolerated when it is not current, not selected for rollback and not part of the active operating state. Current-release drift, wrong support provenance, partial install state, old unit templates, low disk and model partials still fail closed because they can invalidate the next target cycle.

Remaining: sanitized real Raspberry Pi manifests and the exact target campaign are still required. Host replay has not proven physical sensor reads, fan motion, audio behavior, wake/voice behavior, reboot/no-login persistence, update/rollback execution or reinstall on the target.
