...
<!-- MILESTONES -->
Checkpoint scope: **V09 checkpoint 40 expands target-shadow replay to I2C/SHT31 and governed environment profiles. The gate now distinguishes ready full-real evidence from planned I2C reboot, absent SHT31, missing relay GPIO23 and simulation-safe profile states across 11 required fixtures. M10.35 is host-verified as replay/readiness evidence only; no Raspberry Pi release candidate or physical acceptance is claimed. Sanitized real-target manifests, complete host/target-shadow release-candidate gating and the M10.24 hardware/voice/lifecycle campaign remain open.**
