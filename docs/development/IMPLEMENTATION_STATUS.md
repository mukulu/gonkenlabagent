...
<!-- MILESTONES -->
Checkpoint scope: **V09 checkpoint 37 integrates target-shadow replay into release-readiness gating on top of checkpoint 36. The repository now requires replay of the duplicate-RP1-alias PASS fixture and distinct-duplicate expected-FAIL fixture before reporting READY_FOR_HOST_TARGET_SHADOW_GATE. M10.32 is host-verified as an internal reliability gate only; no Raspberry Pi release candidate or physical acceptance is claimed. A real target manifest expansion, exact archive qualification and the M10.24 hardware/voice/lifecycle campaign remain open.**
