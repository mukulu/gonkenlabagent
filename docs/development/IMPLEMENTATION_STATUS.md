...
<!-- MILESTONES -->
Checkpoint scope: **V09 checkpoint 22 user simulation and sensor-deferred HIL release-candidate gating**
...
| M10.8 — Simulation/HIL blueprint expansion | host-verified | not-run | docs/development/V09_SIMULATION_HIL_EXTENSION_PLAN.md; docs/development/V09_SIMULATION_HIL_TRACEABILITY.csv; docs/development/V09_CHECKPOINT_16_REPORT.md; docs/development/V09_CHANGE_VERIFICATION_REPORT_CHECKPOINT_16.md; docs/development/evidence/v09/checkpoint16/focused_baseline.log; docs/development/evidence/v09/checkpoint16/baseline_t0.log Blueprint/control-plane expansion complete. Simulation runtime, mandatory GonKen runtime changes, hardware docs, passive watch, non-actuating check repair and physical acceptance remain implementation work. |
| M10.9 — Simulation foundations | host-verified | not-run | TEST_MATRIX.md (Checkpoint 17); tests/unit/test_v09_environment_simulation.py; affected environment/config/IPC/daemon/CLI test slice Simulation foundations are host-verified. Remaining simulation/HIL work is now simulation-aware voice, hybrid physical/simulation evidence gates, mandatory GonKen wake/progress work, documentation hardening and physical M10.7 acceptance. |
| M10.10 — Operator simulation experience | host-verified | not-run | src/gonken_agent/cli.py; src/gonken_agent/diagnostics.py; src/gonken_agent/support.py; src/gonken_agent/dashboard.py; src/gonken_agent/operations.py; tests/unit/test_v09_environment_cli.py; tests/unit/test_v09_environment_simulation.py; tests/unit/test_diagnostics_snapshot.py; tests/unit/test_grounding_observability.py; tests/unit/test_support_export.py; docs/OPERATIONS.md; docs/development/evidence/v09/checkpoint18/operator_sim_observability_tests.log; docs/development/evidence/v09/checkpoint18/t0_static.log; docs/development/evidence/v09/checkpoint18/targeted_integration.log Operator simulation CLI, passive watch and simulation observability are host-verified. Remaining work moves to simulation-aware voice, hybrid HIL/evidence gates, mandatory GonKen wake/progress work, documentation hardening and real M10.7 physical acceptance. |
...
| M10.12 — Mandatory GonKen wake responsiveness and transition announcements | host-verified | not-run | config/defaults.toml; src/gonken_agent/voice_runtime.py; src/gonken_agent/cli.py; src/gonken_agent/environment/service.py; tests/unit/test_voice_appliance.py; tests/unit/test_v09_environment_polling_loop.py; tests/unit/test_m2_1.py; docs/development/evidence/v09/checkpoint20/affected_wake_transition_tests.log; docs/development/evidence/v09/checkpoint20/t0_static.log; docs/development/evidence/v09/checkpoint20/physical_boundary_regression_tests.log; docs/development/evidence/v09/checkpoint20/active_unit_module_followup.log Default GonKen wake phrase, host wake matcher, progress-cue scheduler, local cue cache contract, wake status diagnostics and voice-owned transition announcements are host-verified. Real wake detection, real progress audio timing and real transition-announcement behavior remain target-gated under M10.7. |
| M10.13 — Documentation and evidence hardening | host-verified | not-run | docs/HARDWARE_SETUP.md; docs/ENVIRONMENT_CONTROL.md; docs/SIMULATION.md; docs/TROUBLESHOOTING.md; docs/ENVIRONMENT_ACCEPTANCE_RUN.md; scripts/validate_v09_docs.py; tests/unit/test_v09_documentation_hardening.py; tests/unit/test_v09_environment_acceptance_runner.py; docs/development/evidence/v09/checkpoint21/affected_docs_evidence_tests.log; docs/development/evidence/v09/checkpoint21/affected_broad_regression_tests.log; docs/development/evidence/v09/checkpoint21/t0_static.log Documentation/evidence hardening is host-verified. Hardware setup, environment control, simulation, troubleshooting and acceptance-runner boundary documentation now exist, documented commands/config keys/links are checked in T0, and the evidence runner manifest records upload requirements and no-acceptance boundaries. Physical M10.7 target gates remain not-run. |
| M10.14 — User simulation and sensor-deferred HIL release candidate | host-verified | not-run | scripts/environment_simulation_runner.py; scripts/v09_user_test_readiness.py; docs/USER_SIMULATION_HIL_HANDOFF.md; tests/unit/test_v09_user_test_readiness.py; tests/integration/test_v09_user_test_release_candidate.py; docs/development/evidence/v09/checkpoint22/ Host release-candidate gating is implemented. A clean committed package may emit READY_FOR_USER_SIMULATION_AND_SENSOR_DEFERRED_HIL only with a fresh commit-bound simulation manifest. Raspberry Pi simulation, real relay/PENGLIN/fan actuation, SHT31, wake/audio and full M10.7 acceptance remain target NOT_RUN and must be collected by the user. |
<!-- /MILESTONES -->
