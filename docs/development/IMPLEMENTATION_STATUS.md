...
| M10.11 — Hybrid HIL and simulation-aware voice | pending | not-run | src/gonken_agent/environment/responses.py; scripts/environment_acceptance_runner.py; tests/unit/test_v09_environment_voice_intents.py; tests/unit/test_v09_environment_acceptance_runner.py; docs/development/evidence/v09/checkpoint19/affected_simulation_voice_hil_tests.log; docs/development/evidence/v09/checkpoint19/t0_static.log Implement hybrid sensor/actuator combinations, voice provenance wording and simulation-aware physical acceptance blocking. Physical actuation remains target-gated. |
| M10.12 — Mandatory GonKen wake responsiveness and transition announcements | pending | not-run | docs/development/V09_SIMULATION_HIL_EXTENSION_PLAN.md Implement default GonKen wake phrase, high-recall continuous/overlapping wake path, matcher corpus, progress cues, local Piper cue cache, wake diagnostics and voice-owned transition announcements. |
| M10.13 — Documentation and evidence hardening | pending | not-run | docs/development/V09_SIMULATION_HIL_EXTENSION_PLAN.md Create hardware setup, environment control, simulation, troubleshooting and evidence/export docs plus documentation command/link/config checks. |
