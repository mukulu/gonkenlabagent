...
<!-- MILESTONES -->
Checkpoint scope: **V09 simulation/HIL implementation checkpoint 17 from checkpoint 16**
...
| M10.14 — User simulation and sensor-deferred HIL release candidate | pending | not-run | docs/development/V09_SIMULATION_HIL_EXTENSION_PLAN.md Produce READY_FOR_USER_SIMULATION_AND_SENSOR_DEFERRED_HIL only after full simulation, sensor-deferred real-fan paths, voice/manual controls, watch, evidence export, docs and rollback/recovery gates pass. |
<!-- /MILESTONES -->
