...
<!-- MILESTONES -->
Checkpoint scope: **V09 simulation/HIL blueprint extension from checkpoint 15**
...
| M10.9 — Simulation foundations | pending | not-run | docs/development/V09_SIMULATION_HIL_EXTENSION_PLAN.md Implement config schema, backend factories, simulated sensor, simulated actuator, simulation state/provenance, protocol operations and core unit tests. |
| M10.10 — Operator simulation experience | pending | not-run | docs/development/V09_SIMULATION_HIL_EXTENSION_PLAN.md Implement env simulate CLI family, passive watch, simulation fault injection, diagnostics/support visibility and full-simulation acceptance tests. |
