...
<!-- MILESTONES -->
Checkpoint scope: **Continuation 06: M8.2 explicit update/rollback lifecycle and maintenance-wrapper correction**
...
| M9.1 — Clean-install and failure campaign | blocked | not-run | TEST_MATRIX.md continuation-01 full regression Full clean-image failure campaign requires physical Pi and post-lifecycle target validation. Host unit/integration suites remain passing through M8.3 and M8.2 update/rollback. |
