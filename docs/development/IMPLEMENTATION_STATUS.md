...
<!-- MILESTONES -->
Checkpoint scope: **V09 checkpoint 36 adds sanitized target-manifest capture and target-shadow GPIO replay on top of the checkpoint-35 reliability-first gate. The repository now contains a non-actuating target_probe tool, a checkpoint-34 duplicate-RP1-alias replay fixture, a distinct-duplicate fail-closed fixture, and release-maintenance inclusion for the probe. M10.31 is host-verified; no Raspberry Pi release candidate or physical acceptance is claimed. A real target manifest, target-shadow replay, host/target-shadow gate, exact archive qualification and the M10.24 hardware/voice/lifecycle campaign remain open.**
