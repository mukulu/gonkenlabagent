...
class ValidationTests(unittest.TestCase):
    INVALID_OVERRIDES = {
        ...
        "gpio conflict": {"runtime.interaction_mode": "push_to_talk", "interaction.recording_led_gpio": 17},
        ...
        "environment relay conflict": {"extensions.environment.enabled": True, "runtime.interaction_mode": "push_to_talk", "extensions.environment.relay_bcm": 17},
