...
class CliTests(unittest.TestCase):
    ...
    def test_wake_status_reports_gonken_default_without_physical_acceptance_claim(self) -> None:
        ...
        self.assertEqual(payload["capture"]["mode"], "streaming-kws-vad")
        self.assertFalse(payload["capture"]["capture_continues_during_transcription"])
        self.assertTrue(payload["capture"]["wake_and_command_share_capture"])
        self.assertFalse(payload["capture"]["dependencies_verified_by_this_command"])
